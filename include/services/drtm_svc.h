...
#define DRTM_FNUM_SVC_REGISTER_ACPI_TABLES	U(0x11A)
...
#define ARM_DRTM_SVC_REGISTER_ACPI_TABLES \
	DRTM_FID(DRTM_FNUM_SVC_REGISTER_ACPI_TABLES)
...
#define is_drtm_fid(_fid) \
	(((_fid) >= ARM_DRTM_SVC_VERSION) && \
	 ((_fid) <= ARM_DRTM_SVC_REGISTER_ACPI_TABLES))
